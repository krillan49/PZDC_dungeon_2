...
# Ошибки:
# При создании нового перса, если существует страрый ран и зайти в него и сохранить и выйти, то создавая новый данж в нем сохранится старый левелинг
...
# Навыки:
# Можно разбить по боевым и небоевым вместо 3х типов
